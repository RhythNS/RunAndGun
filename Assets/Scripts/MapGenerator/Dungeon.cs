...
namespace MapGenerator
{
    public class Dungeon : Map
    {
        ...
        public Dungeon(int sizeX, int sizeY, int seed, Fast2DArray<int>[] roomLayouts, int minCorridorLength, int maxCorridorLength, int maxStructures, float roomChance) : base(sizeX, sizeY) {
            ...
            Room startRoom = new Room(this.roomLayouts[0], rndPosX, rndPosY);
            List<Vector2Int> checkedPositions = new List<Vector2Int>();
            List<Structure> ws = new List<Structure>();
